...
Treat it as working context, not permanent documentation. Long-lived plans still belong in `docs/plans/` and durable design notes still belong in `docs/specs/`.
