...
Follow the shared `disk-clean-audit` contract. This variant frames the work for Gemini-oriented execution while keeping the same read-only audit guarantees.
