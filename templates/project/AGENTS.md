...
3. Start with the bundled `triager`, `builder`, `debater`, `moderator`, `researcher`, and `reviewer` roles. Add specialist agents only when they solve a recurring project need.
