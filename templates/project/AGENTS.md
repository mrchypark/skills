...
3. Start with the bundled `triager`, `builder`, `cost_analyst`, `debater`, `moderator`, `researcher`, and `reviewer` roles. Add specialist agents only when they solve a recurring project need.
